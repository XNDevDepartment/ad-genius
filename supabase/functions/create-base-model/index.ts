...
async function uploadAndProcessModel(supabaseClient: any, userId: string, params: any, googleApiKey: string) {
...
async function generateModelWithAI(supabaseClient: any, userId: string, params: any, googleApiKey: string) {
...
async function saveModel(supabaseClient: any, userId: string, params: any) {
